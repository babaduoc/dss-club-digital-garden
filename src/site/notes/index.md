---
{"dg-publish":true,"permalink":"/index/","title":"📲 DASHBOARD QUẢN TRỊ DỰ ÁN — APP DSS CLUB","tags":["gardenEntry"],"dg-note-properties":{"title":"📲 DASHBOARD QUẢN TRỊ DỰ ÁN — APP DSS CLUB","cssclasses":"dashboard"}}
---
...
## 🏛️ TRUY CẬP NHANH (QUICKSYNC)

- [[DAI_TU_DIEN_SOP_APP_DSSCLUB\|📖 Đại từ điển SOP (App Context)]]
...
> [!TIP]
> **Hướng dẫn cho AI:** Luôn đọc [[DAI_TU_DIEN_SOP_APP_DSSCLUB\|DAI_TU_DIEN_SOP_APP_DSSCLUB]] trước khi thực hiện các yêu cầu liên quan đến logic vận hành App để bảo đảm tính nhất quán của dữ liệu.